...
##  docker build -t 056621886287.dkr.ecr.ap-south-1.amazonaws.com/vjp-ecr-repository_name:V3 . 
## login 
...
## PUSH 
##  docker push 056621886287.dkr.ecr.ap-south-1.amazonaws.com/vjp-ecr-repository_name:V3
